...
<body>
  ...
  <div class="main-container container-fluid">
    ...
    <!-- Page Body -->
    <div class="page-body">
        <button type="button" tooltip="添加用户组" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/admin/rule/add_group'"> <i class="fa fa-plus"></i> 添加用户组
        </button>
        <div class="row">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo U('rule/rule_group',array('id'=>$vo['id']));?>" class="btn btn-default btn-sm purple">
                                                        <i class="fa fa-plus-square"></i> 分配权限
                                                    </a>
                                                    <a href="<?php echo U('rule/check_user',array('id'=>$vo['id']));?>" class="btn btn-default btn-sm">
                                                        <i class="fa fa-plus-square"></i> 添加成员
                                                    </a>
                                                    <a href="<?php echo U('rule/edit_group',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo U('rule/delete_group',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
