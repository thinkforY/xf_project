  ...
  <div class="main-container container-fluid">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('menu/lst');?>">菜单列表</a>
            </li>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo U('menu/save');?>" method="post">
                                <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                                <div class="form-group">
                                    <label for="username" class="col-sm-2 control-label no-padding-right">菜单名称</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" id="name" placeholder="" name="name" value="<?php echo ($data['name']); ?>" required="" type="text">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    <label for="username" class="col-sm-2 control-label no-padding-right">模块/控制器/方法</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" id="mca" placeholder="Admin/Index/index" value="<?php echo ($data['mca']); ?>" name="mca" required="" type="text">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    <label for="username" class="col-sm-2 control-label no-padding-right">图标</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" id="icon" placeholder="" name="icon" value="<?php echo ($data['icon']); ?>" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
