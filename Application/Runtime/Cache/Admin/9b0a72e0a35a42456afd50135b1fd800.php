                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo U('adminUsers/save');?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="gid[]" value="<?php echo ($vo['id']); ?>" class="colored-success">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="radio">
                                            <label>
                                                <input value="1" name="form-field-radio" checked="checked" type="radio" class="inverted">
                                                <span class="text">启用</span>
                                            </label>
                                            <label>
                                                <input value="0" name="form-field-radio" type="radio" >
