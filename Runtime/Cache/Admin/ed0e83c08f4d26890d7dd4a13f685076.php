                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo U('menu/save');?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="mca" placeholder="Admin/Index/index" name="mca" required="" type="text">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="icon" placeholder="" name="icon" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
