...
<body>
  ...
  <div class="main-container container-fluid">
    ...
    <!-- Page Body -->
    <div class="page-body">
        <button type="button" tooltip="添加分类" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/admin/cate/add'"> <i class="fa fa-plus"></i> 添加分类
        </button>
        <div class="row">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="flip-scroll">
                            <form action="<?php echo U('cate/order');?>" method="post">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                                ...
                                                <td align="center"><?php if($vo['catepic'] != ''): ?><img style="width: 100px;height: 26px;" src="<?php echo ($vo['catepic']); ?>" alt=""><?php else: ?>暂无<?php endif; ?></td>
                                                <td align="center">
                                                    <a href="<?php echo U('cate/add',array('pid'=>$vo['id']));?>" class="btn btn-default btn-sm purple">
                                                        <i class="fa fa-plus-square"></i> 添加子分类
                                                    </a>
                                                    <a href="<?php echo U('cate/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo U('cate/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
                                ...
                                <div class="buttons-preview">
                                    <button type="submit" class="btn btn-blue">排序</button>
                                </div>
                            </form>
                        </div>
                        <div>
