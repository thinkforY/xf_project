  ...
  <div class="main-container container-fluid">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('conf/lst');?>">菜单列表</a>
            </li>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo U('conf/editSave');?>" method="post">
                                <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                                 <div class="form-group">
                                    <label for="cname" class="col-sm-2 control-label no-padding-right">中文名称</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" required="" id="cname" placeholder="" name="cname" value="<?php echo ($data["cname"]); ?>" required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" required="" id="ename" placeholder="" name="ename" value="<?php echo ($data["ename"]); ?>" required="" type="text">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" required="" name="d_type" id="d_type">
                                            <option <?php if($data['d_type'] == 1): ?>selected="selected"<?php endif; ?> value="1">输入框</option>
                                            <option <?php if($data['d_type'] == 2): ?>selected="selected"<?php endif; ?> value="2">单选框</option>
                                            <option <?php if($data['d_type'] == 3): ?>selected="selected"<?php endif; ?> value="3">复选框</option>
                                            <option <?php if($data['d_type'] == 4): ?>selected="selected"<?php endif; ?> value="4">下拉菜单</option>
                                            <option <?php if($data['d_type'] == 5): ?>selected="selected"<?php endif; ?> value="5">文本域</option>
                                            <option <?php if($data['d_type'] == 6): ?>selected="selected"<?php endif; ?> value="6">附件</option>
                                        </select>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" required="" name="c_type" id="c_type">
                                            <option <?php if($data['c_type'] == 1): ?>selected="selected"<?php endif; ?> value="1">基本配置</option>
                                            <option <?php if($data['c_type'] == 2): ?>selected="selected"<?php endif; ?> value="2">联系方式</option>
                                            <option <?php if($data['c_type'] == 3): ?>selected="selected"<?php endif; ?> value="3">SEO配置</option>
                                        </select>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" value="<?php echo ($data["value"]); ?>" id="value" placeholder="" name="value" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label  class="col-sm-2 control-label no-padding-right">可选值</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" value="<?php echo ($data["values"]); ?>" id="values" placeholder="" name="values" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
